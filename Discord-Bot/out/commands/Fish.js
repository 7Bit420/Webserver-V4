...
function command(commandInteraction) {
    return __awaiter(this, void 0, void 0, function () {
        var user, userInfo, ammount;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, globalThis.creq('database-v2', {
                        query: {
                ...
                case 2:
                    userInfo = (_a.sent()).body.container;
                    ammount = Math.floor(Math.random() * 35);
                    ...
                    commandInteraction.reply({
                        content: "Fished ".concat(ammount, " dollars"),
                        ephemeral: true
                    });
                    return [2 /*return*/];
            }
